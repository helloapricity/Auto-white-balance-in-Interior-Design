...
def get_args():
    ...
    parser.add_argument('-testdir', '--testing-dir', dest='testdir',
                        default=None, help='Testing directory')
    ...
    parser.add_argument('--grad_acc', type=int, default=1,
                        help='setup gradient accumerlate')
    ...
    parser.add_argument('-sfw', '--save-weights', dest='save_weights',
